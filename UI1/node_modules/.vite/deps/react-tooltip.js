...
var q = ({ forwardRef: t2, id: l2, className: i2, classNameArrow: c2, variant: u = "dark", anchorId: d, anchorSelect: p, place: v = "top", offset: m = 10, events: h2 = ["hover"], openOnClick: w2 = false, positionStrategy: b2 = "absolute", middlewares: S2, wrapper: g2, delayShow: A2 = 0, delayHide: O2 = 0, float: T2 = false, hidden: x2 = false, noArrow: N2 = false, clickable: $2 = false, closeOnEsc: I2 = false, closeOnScroll: B2 = false, closeOnResize: q2 = false, openEvents: H2, closeEvents: M2, globalCloseEvents: W, imperativeModeOnly: P, style: V, position: F, afterShow: K, afterHide: U, content: X, contentWrapperRef: Y, isOpen: G, defaultIsOpen: Z = false, setIsOpen: J, activeAnchor: Q, setActiveAnchor: ee, border: te, opacity: oe, arrowColor: le, role: re = "tooltip" }) => {
  var ne;
  const ie = (0, import_react.useRef)(null), ce = (0, import_react.useRef)(null), se = (0, import_react.useRef)(null), ae = (0, import_react.useRef)(null), ue = (0, import_react.useRef)(null), [de, pe] = (0, import_react.useState)({ tooltipStyles: {}, tooltipArrowStyles: {}, place: v }), [ve, me] = (0, import_react.useState)(false), [fe, ye] = (0, import_react.useState)(false), [he, we] = (0, import_react.useState)(null), be = (0, import_react.useRef)(false), Se = (0, import_react.useRef)(null), { anchorRefs: ge, setActiveAnchor: Ee } = j(l2), Ae = (0, import_react.useRef)(false), [_e, Oe] = (0, import_react.useState)([]), ke = (0, import_react.useRef)(false), Te = w2 || h2.includes("click"), Le = Te || (null == H2 ? void 0 : H2.click) || (null == H2 ? void 0 : H2.dblclick) || (null == H2 ? void 0 : H2.mousedown), Ce = H2 ? { ...H2 } : { mouseover: true, focus: true, mouseenter: false, click: false, dblclick: false, mousedown: false };
  !H2 && Te && Object.assign(Ce, { mouseenter: false, focus: false, mouseover: false, click: true });
  const Re = M2 ? { ...M2 } : { mouseout: true, blur: true, mouseleave: false, click: false, dblclick: false, mouseup: false };
  !M2 && Te && Object.assign(Re, { mouseleave: false, blur: false, mouseout: false });
  const xe = W ? { ...W } : { escape: I2 || false, scroll: B2 || false, resize: q2 || false, clickOutsideAnchor: Le || false };
  P && (Object.assign(Ce, { mouseenter: false, focus: false, click: false, dblclick: false, mousedown: false }), Object.assign(Re, { mouseleave: false, blur: false, click: false, dblclick: false, mouseup: false }), Object.assign(xe, { escape: false, scroll: false, resize: false, clickOutsideAnchor: false })), C(() => (ke.current = true, () => {
    ke.current = false;
  }), []);
  const Ne = (e2) => {
    ke.current && (e2 && ye(true), setTimeout(() => {
      ke.current && (null == J || J(e2), void 0 === G && me(e2));
    }, 10));
  };
  ...
  const $e = (e2) => {
    ...
    R(se), fe ? Ne(true) : se.current = setTimeout(() => {
      Ne(true);
    }, e2);
  }, je = (e2 = O2) => {
    R(ae), ae.current = setTimeout(() => {
      Ae.current || Ne(false);
    }, e2);
  }, Be = (e2) => {
    var t3;
    ...
    if (!(null == o2 ? void 0 : o2.isConnected))
      return ee(null), void Ee({ current: null });
    A2 ? Ie() : Ne(true), ee(o2), Ee({ current: o2 }), R(ae);
  }, ze = () => {
    $2 ? je(O2 || 100) : O2 ? je() : Ne(false), R(se);
  }, De = ({ x: e2, y: t3 }) => {
    var o2;
    const l3 = { getBoundingClientRect: () => ({ x: e2, y: t3, width: 0, height: 0, top: t3, left: e2, right: e2, bottom: t3 }) };
    E({ place: null !== (o2 = null == he ? void 0 : he.place) && void 0 !== o2 ? o2 : v, offset: m, elementReference: l3, tooltipReference: ie.current, tooltipArrowReference: ce.current, strategy: b2, middlewares: S2, border: te }).then((e3) => {
      $e(e3);
    });
  }, qe = (e2) => {
    if (!e2)
    ...
    if (!o2.isConnected)
      return;
    if (null === (t3 = ie.current) || void 0 === t3 ? void 0 : t3.contains(o2))
      return;
    [document.querySelector(`[id='${d}']`), ..._e].some((e3) => null == e3 ? void 0 : e3.contains(o2)) || (Ne(false), R(se));
  }, Me = _(Be, 50, true), We = _(ze, 50, true), Pe = (e2) => {
    We.cancel(), Me(e2);
  }, Ve = () => {
    Me.cancel(), We();
  }, Fe = (0, import_react.useCallback)(() => {
    var e2, t3;
    const o2 = null !== (e2 = null == he ? void 0 : he.position) && void 0 !== e2 ? e2 : F;
    o2 ? De(o2) : T2 ? Se.current && De(Se.current) : (null == Q ? void 0 : Q.isConnected) && E({ place: null !== (t3 = null == he ? void 0 : he.place) && void 0 !== t3 ? t3 : v, offset: m, elementReference: Q, tooltipReference: ie.current, tooltipArrowReference: ce.current, strategy: b2, middlewares: S2, border: te }).then((e3) => {
      ke.current && $e(e3);
    });
  }, [ve, Q, X, V, v, null == he ? void 0 : he.place, m, b2, F, null == he ? void 0 : he.position, T2]);
  (0, import_react.useEffect)(() => {
    var e2, t3;
    const o2 = new Set(ge);
    _e.forEach((e3) => {
    ...
    l3 && o2.add({ current: l3 });
    const r2 = () => {
      Ne(false);
    }, n2 = L(Q), i3 = L(ie.current);
    xe.scroll && (window.addEventListener("scroll", r2), null == n2 || n2.addEventListener("scroll", r2), null == i3 || i3.addEventListener("scroll", r2));
    let c3 = null;
    xe.resize ? window.addEventListener("resize", r2) : Q && ie.current && (c3 = autoUpdate(Q, ie.current, Fe, { ancestorResize: true, elementResize: true, layoutShift: true }));
    const s2 = (e3) => {
      "Escape" === e3.key && Ne(false);
    };
    xe.escape && window.addEventListener("keydown", s2), xe.clickOutsideAnchor && window.addEventListener("click", He);
    const a2 = [], u2 = (e3) => {
      ve && (null == e3 ? void 0 : e3.target) === Q || Be(e3);
    }, p2 = (e3) => {
      ve && (null == e3 ? void 0 : e3.target) === Q && ze();
    ...
    Object.entries(Ce).forEach(([e3, t4]) => {
      ...
      t4 && (v2.includes(e3) ? a2.push({ event: e3, listener: Ve }) : m2.includes(e3) && a2.push({ event: e3, listener: p2 }));
    }), T2 && a2.push({ event: "pointermove", listener: qe });
    const y2 = () => {
      Ae.current = true;
    }, h3 = () => {
      Ae.current = false, ze();
    };
    return $2 && !Le && (null === (e2 = ie.current) || void 0 === e2 || e2.addEventListener("mouseenter", y2), null === (t3 = ie.current) || void 0 === t3 || t3.addEventListener("mouseleave", h3)), a2.forEach(({ event: e3, listener: t4 }) => {
      o2.forEach((o3) => {
        var l4;
      ...
      var e3, t4;
      xe.scroll && (window.removeEventListener("scroll", r2), null == n2 || n2.removeEventListener("scroll", r2), null == i3 || i3.removeEventListener("scroll", r2)), xe.resize ? window.removeEventListener("resize", r2) : null == c3 || c3(), xe.clickOutsideAnchor && window.removeEventListener("click", He), xe.escape && window.removeEventListener("keydown", s2), $2 && !Le && (null === (e3 = ie.current) || void 0 === e3 || e3.removeEventListener("mouseenter", y2), null === (t4 = ie.current) || void 0 === t4 || t4.removeEventListener("mouseleave", h3)), a2.forEach(({ event: e4, listener: t5 }) => {
        o2.forEach((o3) => {
          var l4;
  ...
  }, [Q, Fe, fe, ge, _e, H2, M2, W, Te, A2, O2]), (0, import_react.useEffect)(() => {
    var e2, t3;
    ...
    const r2 = new MutationObserver((e3) => {
      ...
      e3.forEach((e4) => {
        ...
        if ("childList" === e4.type) {
          if (Q) {
            ...
            t5.some((e5) => {
              var t6;
              return !!(null === (t6 = null == e5 ? void 0 : e5.contains) || void 0 === t6 ? void 0 : t6.call(e5, Q)) && (ye(false), Ne(false), ee(null), R(se), R(ae), true);
            });
          }
          if (o2)
            try {
      ...
      }), (t4.length || r3.length) && Oe((e4) => [...e4.filter((e5) => !r3.includes(e5)), ...t4]);
    });
  ...
  }, [l2, p, null == he ? void 0 : he.anchorSelect, Q]), (0, import_react.useEffect)(() => {
    Fe();
  }, [Fe]), (0, import_react.useEffect)(() => {
    if (!(null == Y ? void 0 : Y.current))
      return () => null;
    const e2 = new ResizeObserver(() => {
      setTimeout(() => Fe());
    });
    return e2.observe(Y.current), () => {
      e2.disconnect();
    };
  }, [X, null == Y ? void 0 : Y.current]), (0, import_react.useEffect)(() => {
    var e2;
    const t3 = document.querySelector(`[id='${d}']`), o2 = [..._e, t3];
    Q && o2.includes(Q) || ee(null !== (e2 = _e[0]) && void 0 !== e2 ? e2 : t3);
  }, [d, _e, Q]), (0, import_react.useEffect)(() => (Z && Ne(true), () => {
    R(se), R(ae);
  }), []), (0, import_react.useEffect)(() => {
    var e2;
  ...
  }, [l2, p, null == he ? void 0 : he.anchorSelect]), (0, import_react.useEffect)(() => {
    se.current && (R(se), Ie(A2));
  }, [A2]);
  const Ke = null !== (ne = null == he ? void 0 : he.content) && void 0 !== ne ? ne : X, Ue = ve && Object.keys(de.tooltipStyles).length > 0;
  return (0, import_react.useImperativeHandle)(t2, () => ({ open: (e2) => {
    ...
    we(null != e2 ? e2 : null), (null == e2 ? void 0 : e2.delay) ? Ie(e2.delay) : Ne(true);
  }, close: (e2) => {
    (null == e2 ? void 0 : e2.delay) ? je(e2.delay) : Ne(false);
  }, activeAnchor: Q, place: de.place, isOpen: Boolean(fe && !x2 && Ke && Ue) })), fe && !x2 && Ke ? import_react.default.createElement(g2, { id: l2, role: re, className: (0, import_classnames.default)("react-tooltip", z.tooltip, D.tooltip, D[u], i2, `react-tooltip__place-${de.place}`, z[Ue ? "show" : "closing"], Ue ? "react-tooltip__show" : "react-tooltip__closing", "fixed" === b2 && z.fixed, $2 && z.clickable), onTransitionEnd: (e2) => {
    R(ue), ve || "opacity" !== e2.propertyName || (ye(false), we(null), null == U || U());
  }, style: { ...V, ...de.tooltipStyles, opacity: void 0 !== oe && Ue ? oe : void 0 }, ref: ie }, Ke, import_react.default.createElement(g2, { className: (0, import_classnames.default)("react-tooltip-arrow", z.arrow, D.arrow, c2, N2 && z.noArrow), style: { ...de.tooltipArrowStyles, background: le ? `linear-gradient(to right bottom, transparent 50%, ${le} 50%)` : void 0 }, ref: ce })) : null;
};
var H = ({ content: t2 }) => import_react.default.createElement("span", { dangerouslySetInnerHTML: { __html: t2 } });
var M = import_react.default.forwardRef(({ id: t2, anchorId: l2, anchorSelect: n2, content: i2, html: c2, render: a2, className: u, classNameArrow: d, variant: p = "dark", place: v = "top", offset: m = 10, wrapper: f = "div", children: h2 = null, events: w2 = ["hover"], openOnClick: b2 = false, positionStrategy: S2 = "absolute", middlewares: g2, delayShow: E2 = 0, delayHide: _2 = 0, float: O2 = false, hidden: k2 = false, noArrow: T2 = false, clickable: L2 = false, closeOnEsc: C2 = false, closeOnScroll: R2 = false, closeOnResize: x2 = false, openEvents: N2, closeEvents: $2, globalCloseEvents: I2, imperativeModeOnly: B2 = false, style: z2, position: D2, isOpen: M2, defaultIsOpen: W = false, disableStyleInjection: P = false, border: V, opacity: F, arrowColor: K, setIsOpen: U, afterShow: X, afterHide: Y, role: G = "tooltip" }, Z) => {
  const [J, Q] = (0, import_react.useState)(i2), [ee, te] = (0, import_react.useState)(c2), [oe, le] = (0, import_react.useState)(v), [re, ne] = (0, import_react.useState)(p), [ie, ce] = (0, import_react.useState)(m), [se, ae] = (0, import_react.useState)(E2), [ue, de] = (0, import_react.useState)(_2), [pe, ve] = (0, import_react.useState)(O2), [me, fe] = (0, import_react.useState)(k2), [ye, he] = (0, import_react.useState)(f), [we, be] = (0, import_react.useState)(w2), [Se, ge] = (0, import_react.useState)(S2), [Ee, Ae] = (0, import_react.useState)(null), [_e, Oe] = (0, import_react.useState)(null), ke = (0, import_react.useRef)(P), { anchorRefs: Te, activeAnchor: Le } = j(t2), Ce = (e2) => null == e2 ? void 0 : e2.getAttributeNames().reduce((t3, o2) => {
    var l3;
  ...
  (0, import_react.useEffect)(() => {
    ...
    ke.current !== P && console.warn("[react-tooltip] Do not change `disableStyleInjection` dynamically.");
  }, [P]), (0, import_react.useEffect)(() => {
    ...
    if (i3 && o2.add({ current: i3 }), !o2.size)
      return () => null;
    const c3 = null !== (e2 = null != _e ? _e : i3) && void 0 !== e2 ? e2 : Le.current, s2 = new MutationObserver((e3) => {
      e3.forEach((e4) => {
        var t3;
    ...
    if (c3) {
      const e3 = Ce(c3);
      Re(e3), s2.observe(c3, a3);
    }
    return () => {
      s2.disconnect();
    };
  }, [Te, Le, _e, l2, n2]), (0, import_react.useEffect)(() => {
  ...
  if (a2) {
    ...
    J && (xe = J);
  ee && (xe = import_react.default.createElement(H, { content: ee }));
  const $e = { forwardRef: Z, id: t2, anchorId: l2, anchorSelect: n2, className: (0, import_classnames.default)(u, Ee), classNameArrow: d, content: xe, contentWrapperRef: Ne, place: oe, variant: re, offset: ie, wrapper: ye, events: we, openOnClick: b2, positionStrategy: Se, middlewares: g2, delayShow: se, delayHide: ue, float: pe, hidden: me, noArrow: T2, clickable: L2, closeOnEsc: C2, closeOnScroll: R2, closeOnResize: x2, openEvents: N2, closeEvents: $2, globalCloseEvents: I2, imperativeModeOnly: B2, style: z2, position: D2, isOpen: M2, defaultIsOpen: W, border: V, opacity: F, arrowColor: K, setIsOpen: U, afterShow: X, afterHide: Y, activeAnchor: _e, setActiveAnchor: (e2) => Oe(e2), role: G };
  return import_react.default.createElement(q, { ...$e });
});
